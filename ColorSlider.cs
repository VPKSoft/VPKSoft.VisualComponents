...
// (C): https://www.codeproject.com/articles/17395/owner-drawn-trackbar-slider, GNU Lesser General Public License Version 3
...
namespace MB.Controls
{
    ...
    public partial class ColorSlider : Control
    {
        ...
        /// <summary>
        /// Gets the thumb rect. Useful to determine bounding rectangle when creating custom thumb shape.
        /// </summary>
        ...
        // Added by VPKSoft, 31.01.2018
        /// <summary>
        /// Gets or sets the value if the control can get focus.
        /// </summary>
        [Description("Can the slider get focus")]
        [Category("ColorSlider")]
        [DefaultValue(true)]
        ...
        private int _lastValue = int.MinValue; // 02.06.2018, Added by Petteri Kautonen, VPKSoft, avoid useless refresh..
        ...
        public int Value
        {
            ...
            set
            {
                ...
                {
                    // 02.06.2018, Added by Petteri Kautonen, VPKSoft, avoid useless refresh..
                    if (_lastValue == value)
                    {
                        return;
                    }
                    _lastValue = value; // VPKSoft code end.
        ...
        /// <summary>
        /// Sets the value of Slider without raising an event.
        /// </summary>
        /// <value>The value.</value>
        /// <exception cref="T:System.ArgumentOutOfRangeException">exception thrown when value is outside appropriate range (min, max)</exception>
        [Description("Set Slider value")]
        [Category("ColorSlider")]
        [DefaultValue(50)]
        public int ValueNoEvent // 01.06.2018, Added by Petteri Kautonen, VPKSoft
        {
            set
            {
                if (value >= barMinimum & value <= barMaximum)
        ...
        private int _lastMinimum = int.MinValue; // 02.06.2018, Added by Petteri Kautonen, VPKSoft, avoid useless refresh..
        ...
        public int Minimum
        {
            ...
            {
                // 02.06.2018, Added by Petteri Kautonen, VPKSoft, avoid useless refresh..
                if (_lastMinimum == value)
                {
                    return;
                }
                _lastMinimum = value; // VPKSoft code end.
        ...
        private int _lastMaximum = int.MinValue; // 02.06.2018, Added by Petteri Kautonen, VPKSoft, avoid useless refresh..
        ...
        public int Maximum
        {
            ...
            {
                // 02.06.2018, Added by Petteri Kautonen, VPKSoft, avoid useless refresh..
                if (_lastMaximum == value)
                {
                    return;
                }
                _lastMaximum = value; // VPKSoft code end.
